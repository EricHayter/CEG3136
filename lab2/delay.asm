...
delayms: 
	...
	bsr setDelay ; set our delay

loop:
	bsr polldelay	; check if the delay is over
	cmpa #TRUE		; check return value with true
	bne loop			; if the delay isn't finished loop back
	
	; done looping
	puly	; restore register contents
	pulx
   rts
